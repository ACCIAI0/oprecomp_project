...
int main()
{
  ...
  L = (double**) malloc(NDIM*sizeof(double *));
  U = (double**) malloc(NDIM*sizeof(double *));
  matrix = (double**) malloc(NDIM*sizeof(double *));
  P = (double**) malloc(NDIM*sizeof(double *));
  cond = (double*) malloc(NDIM*sizeof(double *));
  conv = (double*) malloc(NDIM*sizeof(double *));

  for (i=0;i<NDIM;i++)
  {
    L[i]=(double*) malloc(NDIM*sizeof(double));
    U[i]=(double*) malloc(NDIM*sizeof(double));
    matrix[i]=(double*) malloc(NDIM*sizeof(double));
    P[i]=(double*) malloc(NDIM*sizeof(double));
  }

  x = (double*) malloc(NDIM*sizeof(double));
  b = (double*) malloc(NDIM*sizeof(double));
  tmp1 = (double*) malloc(NDIM*sizeof(double));
  p = (double*) malloc(NDIM*sizeof(double));
  resid = (double*) malloc(NDIM*sizeof(double));
  z = (double*) malloc(NDIM*sizeof(double));
  gx =(double*)  malloc(NDIM*sizeof(double));
  iwork = (int *) malloc((NDIM+1)*sizeof(int));
  work = (double*) malloc(NDIM*sizeof(double));
  A = (double*) malloc(NDIM*NDIM*sizeof(double));
  ipiv = (int *) malloc(NDIM*sizeof(int));
  info = (int *) malloc(sizeof(int));
  rcond = (double*) malloc((4*NDIM+1)*sizeof(double));
